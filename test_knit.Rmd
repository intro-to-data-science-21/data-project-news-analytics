...
Alldays$word <- factor(Alldays$word, levels = Alldays$word[order(Alldays$occurrences)])
 ...
 Alldays <- Alldays %>% ggplot(aes(x=word, 
   ...
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words across the 5 countries ")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_All$word <- factor(December16_All$word, levels = December16_All$word[order(December16_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by all newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_UK$word <- factor(December16_UK$word, levels = December16_UK$word[order(December16_UK$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by UK newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_US$word <- factor(December16_US$word, levels = December16_US$word[order(December16_US$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by US newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by Canada newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by New Zealand newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
  ...
  xlab("")+
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 15 most frequently used words by Australia newspapers on December 16")) +
     geom_blank()
...
graph_australia <- graph_australia_data %>% 
  ...
  geom_line() +
  geom_point(size = 0.4) +
  labs(title = "The frequency of the most used words in headlnes of Australian newspapers") +
  ylab("Frequency") +
  xlab("Date") +
  scale_x_discrete(labels = c("2021-12-09-00-01-58"="Dec\n 9",  "2021-12-09-04-01-37"= "", "2021-12-09-08-01-21"= "", "2021-12-09-12-01-27"= "", "2021-12-09-16-01-24" = "", "2021-12-09-20-01-54" = "",
                              "2021-12-10-00-01-51"="Dec\n 10", "2021-12-10-04-01-37"= "", "2021-12-10-08-01-15"= "", "2021-12-10-12-01-29"= "", "2021-12-10-16-02-11" = "", "2021-12-10-20-01-28" = "", 
