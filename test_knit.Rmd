...
group_by(word) %>% 
 ...
 December16_All$word <- factor(December16_All$word, levels = December16_All$word[order(December16_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by all newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_UK$word <- factor(December16_UK$word, levels = December16_UK$word[order(December16_UK$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by UK newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_US$word <- factor(December16_US$word, levels = December16_US$word[order(December16_US$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by US newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by Canada newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by New Zealand newspapers on December 16")) +
     geom_blank()
...
group_by(word) %>% 
  ...
  xlab("")+
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("The 20 most frequently used words by Australia newspapers on December 16")) +
     geom_blank()
