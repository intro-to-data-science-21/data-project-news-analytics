...
author: 
- Abhiram Mohan ([website](https://github.com/Abhilearns2code)) | 205928
- Koen Oosthoek ([website](https://github.com/koenoosthoek))      | 204638
output: 
  html_document:
    toc: FALSE
    df_print: paged
...
```{r message = FALSE, warning = FALSE, include = FALSE}
# adding a new column to count the words -------------------------------------------------------
...
### Introduction
It is often said that "breaking news", speculative and sensational headlines are at the centre of today's 24-hour news cycle. In order to survive in today's fast-paced media landscape, outlets need to compete for audiences that subscribe to their platform. Some authors underline the dangers this may pose to trustworthy information and an an informed public debate more generally - and refer to the "menace of media speed and the 24-hour news cycle". ^[Rosenberg, H., & Feldman, C. S. (2008). No Time To Think. Bloomsbury Academic.] If outlets want to survive in the market, they need to compete and attract as many users as possible. The gain for outlets is twofold: if more users subscribe to a platform, this does not just raise revenue in itself, but also makes the platform more attractive to advertisors. 

We want to deepen our understanding of today's news-cycle. In this article, we will research how media headlines develop over time. We chose to focus on the words that are used in the headlines of the largest newspapers in the US, UK, Canada, Australia and New-Zealand. We scraped over a million headlines between December 9 00:01 CET and December 16 20:00 CET, with a time-interval of four hours. 

## Our data {.tabset .tabset-fade .tabset-pills}
...
## Part 1: Most used words {.tabset .tabset-fade .tabset-pills}
...
## Part 2: The development of words {.tabset .tabset-fade .tabset-pills}
