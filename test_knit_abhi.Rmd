...
December9_All$word <- factor(December9_All$word, levels = December9_All$word[order(December9_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all the newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December9_UK <- December9_UK %>%  ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +                                  
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 9th ")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December9_Us <- December9_Us %>%  ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December9_Canada <- December9_Canada %>% ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December9_NZ <- December9_NZ %>% ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December9_Aus <- December9_Aus %>% ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australian newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December10_All <-  December10_All %>%  ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all the newspapers on December 10th")) + 
     geom_blank()
...
ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 10th")) + 
     geom_blank()
...
December10_US <- December10_US %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 10th")) + 
     geom_blank()
 ...
 December10_Canada$word <- factor(December10_Canada$word, levels = December10_Canada$word[order(December10_Canada$occurrences)])
  ...
  December10_Canada <- December10_Canada %>%   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 10th")) + 
     geom_blank()
...
December10_NZ$word <- factor(December10_NZ$word, levels = December10_NZ$word[order(December10_NZ$occurrences)])
 ...
 December10_NZ <- December10_NZ %>%    ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 10th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December10_Aus <-December10_Aus %>%   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 10th")) + 
     geom_blank()
 ...
 December11_All$word <- factor(December11_All$word, levels = December11_All$word[order(December11_All$occurrences)])
   ...
   December11_All <-  December11_All %>%  ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all the newspapers on December 11th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December11_UK <- December11_UK %>%   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 11th")) + 
     geom_blank()
...
December11_US <-  December11_US %>%   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 11th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December11_Canada <-December11_Canada %>%  ggplot(aes(x=word, y=occurrences)) +
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 11th")) + 
     geom_blank()
 ...
 December11_NZ$word <- factor(December11_NZ$word, levels = December11_NZ$word[order(December11_NZ$occurrences)]) 
  ...
  December11_NZ <-December11_NZ %>%   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 11th")) + 
     geom_blank()
 ...
 December11_Aus$word <- factor(December11_Aus$word, levels = December11_Aus$word[order(December11_Aus$occurrences)]) 
   ...
   December11_Aus <- December11_Aus %>% ggplot(aes(x= word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 11th")) + 
     geom_blank()
...
December12_All <-December12_All %>% ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all newspapers on December 12th")) + 
     geom_blank()
...
December12_UK <-December12_UK %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 12th")) + 
     geom_blank()
...
December12_US <-December12_US %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 12th")) + 
     geom_blank()
...
December12_Canada <-December12_Canada %>%
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 12th")) + 
     geom_blank()
 ...
 December12_NZ$word <- factor(December12_NZ$word, levels = December12_NZ$word[order(December12_NZ$occurrences)])
  ...
  December12_NZ <-December12_NZ %>%  ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 12th")) + 
     geom_blank()
 ...
 December12_Aus <-December12_Aus %>% 
   ggplot(aes(x=word, 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 9th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December13_All$word <- factor(December13_All$word, levels = December13_All$word[order(December13_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December13_Canada$word <- factor(December13_Canada$word, levels = December13_Canada$word[order(December13_Canada$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December13_Aus$word <- factor(December13_Aus$word, levels = December13_Aus$word[order(December13_Aus$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 13th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December14_All$word <- factor(December14_All$word, levels = December14_All$word[order(December14_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all newspapers on December 14th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 14th")) + 
     geom_blank()
...
group_by(word) %>% 
   ...
   December14_US$word <- factor(December14_US$word, levels = December14_US$word[order(December14_US$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 14th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 14th")) + 
     geom_blank()
...
December14_NZ$word <- factor(December14_NZ$word, levels = December14_NZ$word[order(December14_NZ$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 14th")) + 
     geom_blank()
...
group_by(word) %>% 
   ...
   December14_Aus$word <- factor(December14_Aus$word, levels = December14_Aus$word[order(December14_Aus$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 14th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
   ...
   December15_UK$word <- factor(December15_UK$word, levels = December15_UK$word[order(December15_UK$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
   ...
   December15_Aus$word <- factor(December15_Aus$word, levels = December15_Aus$word[order(December15_Aus$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 15th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_All$word <- factor(December16_All$word, levels = December16_All$word[order(December16_All$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by all newspapers on December 16th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_UK$word <- factor(December16_UK$word, levels = December16_UK$word[order(December16_UK$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by UK newspapers on December 16th")) + 
     geom_blank()
...
group_by(word) %>% 
 ...
 December16_US$word <- factor(December16_US$word, levels = December16_US$word[order(December16_US$occurrences)])
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by US newspapers on December 16th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Canada newspapers on December 16th")) + 
     geom_blank()
...
group_by(word) %>% 
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by New Zealand newspapers on December 16th")) + 
     geom_blank()
...
group_by(word) %>% 
  ...
  xlab("word")+
    ...
    coord_flip() +
     theme_minimal() +
   scale_fill_gradient(high = "#f6a97a", low="#ca3c97") +
     ggtitle(paste("Top", 20 , "frequently used words by Australia newspapers on December 16th")) + 
     geom_blank()
